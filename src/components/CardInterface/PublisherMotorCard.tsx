...
export default function PublisherMotorCard({ device, setDetail }) {
  ...
  const handleSwitchClick = (e) => {
    ...
    setIsOn(newStatus);
    console.log(`Status motor listrik: ${newStatus ? "ON" : "OFF"}`);
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Motor Listrik bisa ditambahkan detail icon di dalam */}
        </div>
